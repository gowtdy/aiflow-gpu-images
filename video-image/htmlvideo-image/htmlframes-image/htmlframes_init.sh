echo "set htmlframes-image host directory permission..."
...
# 确保目录存在
mkdir -p /home/aigc/data/aioutput/htmlframes-logs
# 设置目录权限，确保可以写入
chmod -R 755 /home/aigc/data/aioutput/htmlframes-logs/
...
ls -la /home/aigc/data/aioutput/htmlframes-logs/