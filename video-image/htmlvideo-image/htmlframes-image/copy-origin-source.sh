...
if [ -d "${bak_path}/skills/aiflow-build-frame-visual" ]; then
  cp -r "${bak_path}/skills/aiflow-build-frame-visual" "${target_path}/skills/"
fi
if [ -d "${bak_path}/skills/aiflow-build-frame-html" ]; then
  cp -r "${bak_path}/skills/aiflow-build-frame-html" "${target_path}/skills/"
fi
