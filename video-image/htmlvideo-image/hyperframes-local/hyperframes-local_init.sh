echo "set hyperframes local host directory permission..."
...
# 确保目录存在
mkdir -p /home/aigc/data/aioutput/hyperframes-local-logs
# 设置目录权限，确保可以写入
...
ls -la /home/aigc/data/aioutput/hyperframes-local-logs/