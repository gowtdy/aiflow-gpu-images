...
class IndexTTS2:
    def __init__(
        ...
        w2v_bert_path = getattr(self.cfg, "w2v_bert_path", None)
        ...
        semantic_codec_path = getattr(self.cfg, "semantic_codec_path", None)
        semantic_code_ckpt = os.path.join(semantic_codec_path, "semantic_codec", "model.safetensors")
        ...
        #)
        campplus_path = getattr(self.cfg, "campplus_path", None)
